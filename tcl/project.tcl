...
make_wrapper -files [get_files ${MODULE}/${outputDir}/${MODULE}.srcs/sources_1/bd/${MODULE}/${MODULE}.bd] -top
# Add all files
add_files -norecurse ${MODULE}/${outputDir}/${MODULE}.srcs/sources_1/bd/${MODULE}/hdl/${MODULE}_wrapper.v
